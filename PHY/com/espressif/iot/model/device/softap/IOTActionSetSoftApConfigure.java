...
public class IOTActionSetSoftApConfigure extends IOTAction{
	
	private final String TAG = "IOTActionSetSoftApConfigure";

	public IOTActionSetSoftApConfigure(IOTDevice iotDevice) {
		super(iotDevice);
	...
	protected boolean action() {
		...
		return intermediator.executeIOTAction(mIOTDevice,
				IOTActionEnum.IOT_ACTION_SET_SOFTAP_CONFIGURE);
	}
